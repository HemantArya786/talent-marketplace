...
//           `http://localhost:3000/api/search/search-users?q=${encodeURIComponent(
//             debouncedSearch
//           )}`
//         );

//         setResults(res.data?.users || []); // adjust this depending on API response structure
//       } catch (error) {
...
//                     className="px-6 py-3 hover:bg-gray-100 cursor-pointer border-b"
//                     onClick={() => {
//                       setSearch(user?.name || ""); // adjust based on actual user structure
//                       setResults([]);
//                     }}
//                   >
